...
<%@include file="header.jsp"%>
 ...
 <div class="container form-signin" style="padding-top:70px;">
       <div class="hero-unit" style="padding: 20px;">
        ...
        <p>我们的愿景是共享大家附近的书籍  目前为止  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp图书<%=bookCount%>本&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp馆君<%=userCount%>位 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp图书馆<%=libraryCount%>座</p>
      </div>
